...
const generateMetaTags = async (url) => {
  let metaData = {
    title:
      "ClickBIT - Web Development, Digital Marketing & IT Solutions Australia",
    description:
      "Leading web development, digital marketing & IT solutions in Australia. Custom software, mobile apps, cloud solutions & comprehensive IT support for startups and small businesses.",
  ...
  if (url === "/" || url === "") {
    metaData = {
      title: "ClickBIT Home",
      description:
        "Empowering businesses with innovative digital solutions to connect, engage, and grow. Expert web development, custom applications, and IT support services.",
      image: "https://clickbit.com.au/images/logos/logo-full.png",
    ...
    metaData = {
      title: "About Us",
      description:
        "Meet the ClickBit team - passionate experts delivering customized IT solutions. Learn about our mission to empower businesses with innovative digital strategies.",
      image: "https://clickbit.com.au/images/logos/logo-full.png",
    ...
    metaData = {
      title: "Contact Us",
      description:
        "Get in touch with ClickBit's expert team. Ready to start your project? Contact us for professional web development, software solutions, and IT services.",
      image: "https://clickbit.com.au/images/logos/logo-full.png",
    ...
    metaData = {
      ...
      description:
        "Explore ClickBIT's portfolio of successful web development, mobile app, and digital solution projects. See our work for clients across Australia.",
      image: "https://clickbit.com.au/images/logos/logo-full.png",
    ...
    metaData = {
      title: "Our Services",
      description:
        "Comprehensive web development, digital marketing, and IT solutions. Custom software, mobile apps, cloud solutions, and IT support across Australia.",
      image: "https://clickbit.com.au/images/logos/logo-full.png",
    ...
    metaData = {
      ...
      description:
        "Stay updated with the latest web development trends, digital marketing insights, and IT solutions from the ClickBIT team.",
      image: "https://clickbit.com.au/images/logos/logo-full.png",
  ...
  try {
    ...
    if (url.startsWith("/blog/")) {
      ...
      if (post) {
        metaData = {
          ...
          description:
            post.excerpt ||
            `${post.title} - Read the latest insights and updates from the ClickBit team.`,
          image: post.featured_image
            ? post.featured_image.startsWith("http")
              ? post.featured_image
              : `https://clickbit.com.au${post.featured_image}`
    ...
    if (url.startsWith("/portfolio/")) {
      ...
      if (item) {
        metaData = {
          ...
          description:
            item.description ||
            `${item.title} - A portfolio project by ClickBIT showcasing ${item.category} development.`,
          image: item.featured_image
            ? item.featured_image.startsWith("http")
              ? item.featured_image
              : `https://clickbit.com.au${item.featured_image}`
            : "https://clickbit.com.au/images/logos/logo-full.png",
    ...
    if (url.startsWith("/services/")) {
      ...
      metaData = {
        title: `${slug
          .replace(/-/g, " ")
          .replace(/\b\w/g, (l) => l.toUpperCase())} Services | ClickBIT`,
        description: `Professional ${slug.replace(
          /-/g,
          " "
        )} services by ClickBit. Custom solutions tailored to your business needs.`,
        image: "https://clickbit.com.au/images/logos/logo-full.png",
...
const generateFallbackMetaTags = (url) => {
  ...
  let contextualDescription =
    "Professional web development and digital marketing solutions by ClickBIT.";
  ...
  if (pathSegments.includes("blog")) {
    ...
    pathSegments.includes("careers") ||
    pathSegments.includes("jobs")
  ) {
...
const generateStructuredData = (metaData, url) => {
  const baseStructuredData = {
    ...
    description:
      "Leading web development, digital marketing & IT solutions in Australia",
    address: {
      "@type": "PostalAddress",
      addressCountry: "AU",
    },
    sameAs: ["https://linkedin.clickbit.com.au", "https://x.clickbit.com.au"],
  };
...
const injectMetaTags = (html, metaData, url) => {
  ...
  const existingMetaPattern =
    /<meta property="og:title"[^>]*>[\s\S]*?<link rel="canonical"[^>]*>/;
...
const socialMediaCrawlerMiddleware = async (req, res, next) => {
  ...
  const shouldProcess =
    ...
    ["/", "/about", "/contact", "/portfolio", "/services", "/blog"].includes(
      req.path
    );
